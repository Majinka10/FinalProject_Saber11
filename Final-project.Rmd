...
```{r cor_tienepc_punt, fig.align='center'}
...
```{r Promedio de notas en los departamentos de Colombia y municipios de Santander, fig.align='center', eval=FALSE}
...
```{r Mapeo de promedio de colegios en zona urbana y rural, fig.align='center', eval=FALSE}
