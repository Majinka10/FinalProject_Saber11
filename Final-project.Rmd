...
Las correlaciones subrayan esta relación: tener estos recursos correlaciona
positivamente con puntajes más altos. Esto apunta a desigualdades socioeconómicas
...
pero para no hacer suposiciones decidimos comprobarlo en el siguiente análisis.
