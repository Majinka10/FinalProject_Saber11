...
boxplot(nuevo_df$PUNT_GLOBAL, xlab="Puntaje", horizontal = TRUE)

boxplot(nuevo_df$ESTU_NSE_INDIVIDUAL, xlab="NSE", horizontal = TRUE)
...
ggplot(nuevo_df, aes(x = nuevo_df$ESTU_NSE_INDIVIDUAL==4, y = nuevo_df$PUNT_GLOBAL)) +
  geom_boxplot() +
  labs(x = "Nuvel socioeconomico", y = "Puntaje Global") +
...
```{r cor_todas}
hist(data$FAMI_TIENECOMPUTADOR)
```